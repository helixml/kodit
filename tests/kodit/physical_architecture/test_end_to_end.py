...
class TestEndToEndArchitectureDiscovery:
    ...
    @pytest.mark.asyncio
    async def test_full_discovery_with_simple_web_app(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_docker_compose_component_detection(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_connection_detection(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_kubernetes_component_detection(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_empty_repository(self, tmp_path) -> None:
...
class TestApplicationServiceIntegration:
    ...
    @pytest.mark.asyncio
    async def test_create_enrichment_from_discovery(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_extract_architecture_from_enrichment(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_invalid_enrichment_type_raises_error(self) -> None:
