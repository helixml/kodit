...
class TestDockerComposeDetector:
    ...
    def test_detect_components_from_simple_compose_file(self) -> None:
    ...
    def test_detect_connections_from_depends_on(self) -> None:
    ...
    def test_detect_with_no_compose_files(self, tmp_path) -> None:
    ...
    def test_detect_with_empty_compose_file(self, tmp_path) -> None:
