...
func NewTask(operation TaskOperation, priority int, payload map[string]any) Task {
...
func (t Task) Operation() TaskOperation { return t.operation }
...
func createDedupKey(operation TaskOperation, payload map[string]any) string {
