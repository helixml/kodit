"""Service for extracting code snippets from commits."""
...
class SnippetExtractionService:
    """Handles snippet extraction from commits."""
    ...
    def __init__(  # noqa: PLR0913
        ...
        """Initialize the snippet extraction service."""
    ...
    async def extract_snippets(
        ...
        """Extract snippets from a commit and save them."""
        async with self.operation.create_child(
            ...
            # Load files on demand for snippet extraction
            ...
            # Deduplicate snippets by SHA before saving
