...
Revision ID: 908d708dc5b4
Revises: 9cf0e87de578
Create Date: 2025-09-04 16:47:10.944176
...
def upgrade() -> None:
    ...
    op.create_index(op.f("ix_task_status_step"), "task_status", ["step"], unique=False)
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_task_status_step"), table_name="task_status")
