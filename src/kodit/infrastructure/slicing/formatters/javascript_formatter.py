"""JavaScript API documentation formatter."""
...
class JavaScriptAPIDocFormatter(CppAPIDocFormatter):
    """Formats JavaScript code into API documentation markdown."""

    def __init__(self) -> None:
        """Initialize the formatter."""
        super().__init__()
        self._code_fence = "javascript"
    ...
    def _format_method(
        ...
        """Format a method with JavaScript dot notation."""
