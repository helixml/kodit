"""Java API documentation formatter."""
...
class JavaAPIDocFormatter(CppAPIDocFormatter):
    """Formats Java code into API documentation markdown."""

    def __init__(self) -> None:
        """Initialize the formatter."""
        super().__init__()
        self._code_fence = "java"
    ...
    def _format_method(
        ...
        """Format a method with Java dot notation."""
