"""Rust API documentation formatter."""
...
class RustAPIDocFormatter(CppAPIDocFormatter):
    """Formats Rust code into API documentation markdown."""

    def __init__(self) -> None:
        """Initialize the formatter."""
        super().__init__()
        self._code_fence = "rust"
    ...
    def _format_method(
        ...
        """Format a method with Rust double-colon notation."""
