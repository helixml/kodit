...
func (s Source) WorkingCopy() WorkingCopy {
	return s.repo.WorkingCopy()
}

// TrackingConfig returns the tracking configuration.
func (s Source) TrackingConfig() TrackingConfig {
...
func (s Source) WithWorkingCopy(wc WorkingCopy) Source {
...
func (s Source) WithTrackingConfig(tc TrackingConfig) Source {
	s.repo = s.repo.WithTrackingConfig(tc)
	return s
}

// WithRepository returns a new Source with an updated Repository.
func (s Source) WithRepository(repo Repository) Source {
	s.repo = repo
	return s
}
